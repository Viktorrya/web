                            ...
                            <div>
                                <form class="login_form" method="post">
                                    ...
                                    <div class="form-group form-check">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="acceptRule" name="accep">
                                    </div>
                                    <div class="form-group form-check">
                                        <label class="form-check-label" for="acceptRules">строитель</label>
                                        <input type="checkbox" class="form-check-input" id="acceptRul" name="acce">
                                    </div>
                                    <div class="form-group form-check">
                                        <label class="form-check-label" for="acceptRules">врач</label>
                                        <input type="checkbox" class="form-check-input" id="acceptRu" name="acc">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group form-check">
                                        <input type="checkbox" class="form-check-input" id="acceptRules" name="accept">
                                        <label class="form-check-label" for="acceptRules">Готов отаться на марсе</label>
                                    </div>
